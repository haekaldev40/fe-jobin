...
import { recruiterSchema } from "@/schemas/AuthSchema";

const FormRegisterRecruiter = () => {
  const navigate = useNavigate();
  const { toast } = useToast();
  const registerRecruiter = useAuthStore((state) => state.registerRecruiter);
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input className="h-12 px-4 rounded-lg" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
